			...
			<table class="table table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<a href="{{route('editar_persona',$persona->id)}}" class="btn btn-warning btn-xs fa fa-edit" data-toggle="tooltip" data-placement="top" title="" data-original-title="Editar"></a>
						</td>
					</tr>
					@endforeach
				</tbody>
