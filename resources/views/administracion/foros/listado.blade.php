			...
			<table class="table table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<a href="{{route('editar_foro',$foro->id)}}" class="btn btn-warning btn-sm btn-flat fa fa-edit" data-toggle="tooltip" data-placement="top" title="" data-original-title="Editar"></a>
							<a href="{{route('mensajes_foro',$foro->id)}}" class="btn btn-info btn-sm btn-flat fa fa-eye" data-toggle="tooltip" data-placement="top" title="" data-original-title="Ver"></a>
						</td>
					</tr>
					@endforeach
				</tbody>
