...
<div class="user-block">
  ...
  <span class="description">Iniciado por {{$foro->autor->nombre_completo}} el {{date('d/m/Y - H:i', strtotime($foro->created_at))}} 
  <a href="{{route('estudiantes.foros',$foro->curso_id)}}" class="btn btn-danger btn-sm btn-flat fa fa-chevron-left" style="float:right"> Regresar</a></span>  
</div>
<br/>
<div class="col-md-12">
