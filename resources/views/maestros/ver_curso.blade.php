						...
						<div class="info-box bg-green">
							...
							<div class="info-box-content">
								...
								<span class="info-box-number">{{count($curso->unidades)}}</span>
									...
									<a href="{{route('unidades_curso',$curso->id)}}" style="color: white">Ver Unidades <i class="fa fa-chevron-right"></i></a>
								</span>
							</div>
						</div>
					</div>
						...
						<div class="info-box bg-red">
							...
							<div class="info-box-content">
								...
								<span class="info-box-number">{{count($curso->foros)}}</span>
									...
									<span class="progress-description">
									<a href="{{route('foros',$curso->id)}}" style="color: white">Ver Foro <i class="fa fa-chevron-right"></i></a>
								</span>
							</div>
						</div>
					</div>
