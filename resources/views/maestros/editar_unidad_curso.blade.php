...
<div class="box box-primary">
	{!! Form::model($unidadCurso, ['route' => ['maestros.editar_unidad_curso',$unidadCurso->id], 'method' => 'PUT', 'id' => 'form', 'class'=>'validate-form','files'=>'true']) !!}
	    <div class="box-body">
		...
		<div class="box-footer">
            ...
            <a href="{{ route('maestros.ver_curso',$unidadCurso->curso_id) }}" class="btn btn-danger btn-flat">Cancelar</a>     
		</div>
	{!! Form::close() !!}
</div>
@endsection
