<html>
	...
	<body>
			...
			<div class="col-lg-12">
				<table class="table table-responsive">
					<tr>
						...
						<td>{{$estudiante['estudiante']->estudiante->nombre_completo_apellidos}}</td>
					</tr>
					<tr>
		...
		<div class="row">
			<div class="col-lg-12">
				<table class="table table-bordered" >
					...
					<tbody>
						@php $index=0; @endphp
						@foreach($estudiante['notas']['cursos'] as $nota)
							@php $index++; @endphp
							<tr>
						...
						<tr>
							<td></td>
							<td>PROMEDIO</td>
							@foreach($estudiante['notas']['promedios']['unidades'] as $p)
		...
		<div class="row">
			<div class="col-lg-12">
				Yo _________________________________________, encargado de: __<b><u>{{$estudiante['estudiante']->estudiante->nombre_completo_apellidos}}</u></b>__ del grado: __<b><u>{{$seccion->descripcion_con_grado}}</u></b>__, firmo este codo como constancia del informe de calificaciones. 
				<br/><br/><br/>
